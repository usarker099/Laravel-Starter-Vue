    ...
    <div class="fixed inset-0 overflow-y-auto px-4 py-6 sm:px-0 z-50" scroll-region>
      ...
      >
        <div v-show="show" class="fixed inset-0 transform transition-all" @click="close">
          <div class="absolute inset-0 bg-base-content/50" />
        </div>
      </transition>
      ...
      >
        <div
          v-show="show"
          class="mb-6 rounded-lg overflow-hidden shadow-xl transform transition-all sm:w-full sm:mx-auto bg-base-100"
          :class="maxWidthClass"
        >
          <slot v-if="showSlot"/>
        </div>
